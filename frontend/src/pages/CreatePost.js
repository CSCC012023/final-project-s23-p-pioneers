...
import { Container, Grid, Box, Typography, alpha, Button, TextField, IconButton } from '@mui/material';
...
const jobsData = [
  ...
  },
  {
    ...
    location: 'San Francisco',
    type: 'Full-time',
    image: 'https://www.googlewatchblog.de/wp-content/uploads/google-logo-perfekt.jpg',
  },

  {
    ...
    location: 'San Francisco',
    type: 'Full-time',
    image: 'https://www.nokia.com/sites/default/files/styles/scale_1440_no_crop/public/2023-02/nokia-refreshed-logo-2_1.png',
  },
...
//   };
  ...
  return (
    ...
    <Box textAlign="center" marginBottom={2}>
        <Typography variant="h2" sx={{ color: 'white', fontFamily: 'Work-Sans' }}>
          Create Post
        </Typography>
    </Box>
...
const JobGrid = ({ jobs }) => {
  return (
    <Container maxWidth="lg" sx={{ marginTop: '20px' }}> {/* Adjust the maxWidth value as per your design */}
    <Grid container spacing={2}>
      {jobs.length === 0 ? (
        <Grid item xs={12}>
